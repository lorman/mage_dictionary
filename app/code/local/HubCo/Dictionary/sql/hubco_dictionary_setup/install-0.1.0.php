...
$table->addColumn ( 'abbreviation', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'translation', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'suppliers', Varien_Db_Ddl_Table::TYPE_TEXT, null, array (
    'nullable' => false
) );
$table->addColumn ( 'brands', Varien_Db_Ddl_Table::TYPE_TEXT, null, array (
    'nullable' => false
) );
$table->addColumn ( 'categories', Varien_Db_Ddl_Table::TYPE_TEXT, null, array (
    'nullable' => false
) );
...
$table->addColumn ( 'attribute_name', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'attribute_code', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'value', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'translation', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'ignore', Varien_Db_Ddl_Table::TYPE_BOOLEAN, 1, array (
    'nullable' => true
) );
$table->addColumn ( 'description', Varien_Db_Ddl_Table::TYPE_BOOLEAN, 1, array (
    'nullable' => true
) );
$table->addColumn ( 'suppliers', Varien_Db_Ddl_Table::TYPE_TEXT, null, array (
    'nullable' => false
...
$table->addColumn ( 'supplier_make', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'translated_make', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'suppliers', Varien_Db_Ddl_Table::TYPE_TEXT, null, array (
    'nullable' => false
...
$table->addColumn ( 'make', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'supplier_model', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'translated_model', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array (
    'nullable' => false
) );
$table->addColumn ( 'suppliers', Varien_Db_Ddl_Table::TYPE_TEXT, null, array (
    'nullable' => false
